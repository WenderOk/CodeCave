...
-- price > all (select price from books where author = 'Chuck Palahniuk');
-- select * from (select title, author, price from Books) as BooksCopy where author = "J.R.R Tolkien";
-- select (select sum(price) from books) as total;